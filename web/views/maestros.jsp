...
<html lang="en">
        ...
        <div class="col-md-12">
            <div class="col-md-3 col-md-offset-1">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li role="presentation"><a id="mae-btn-ponderacion" href="#">Ponderacion de Clases</a></li>
                    <li role="presentation"><a id="mae-btn-notas" href="#">Notas Alumnos</a></li>
                    <li role="presentation"><a id="mae-btn-reclamo" href="#">Ingresar Reclamo</a></li>
                    <li role="presentation"><a id="mae-btn-reportes" href="#">Reportes</a></li>
                    <li role="presentation"><a id="mae-btn-buses" href="#">Rutas de buses</a></li>
    ...
    <script>
        ...
        $("#mae-btn-ponderacion").click(function () {
        ...
        function ShowView(view_id) {
            ...
            $("#mae-ponderacion").collapse(ponderacion);
